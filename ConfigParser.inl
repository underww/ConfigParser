template <typename T>
void ConfigParser::toValue(std::string& str, T& value)
{
...
template <>
inline void ConfigParser::toValue<std::string>(std::string& str, std::string& value)
{
	trim(str);
	value = str;
}
...
template <typename T>
void ConfigParser::toValue(std::istringstream& iss, T& value)
{
	std::string str;
